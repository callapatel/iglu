...
RSpec.configure do |config|
  config.before(:suite) do
    ...
    OmniAuth.config.mock_auth[:instagram] = OmniAuth::AuthHash.new({credentials: {token: '123456', secret: '123456'}, uid: '123456', provider: "Instagram", info: {email: "a@b.com", nickname: "Calla"}})
  end
